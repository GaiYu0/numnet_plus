...
class DropDataset(Dataset):
    def __init__(self, data_args, data_mode, tokenizer):
        self.is_train = data_mode == "train"
        dpath = "tmspan_cached_roberta_{}.pkl".format(data_mode)
        with open(os.path.join(data_args.data_dir, dpath), "rb") as f:
...
class DropDataCollator:
    def __init__(self, tokenizer, padding_idx=1):
    ...
    def __call__(self, batch):
        ...
        return {"input_ids": input_ids, "input_mask": input_mask, "input_segments": input_segments,
